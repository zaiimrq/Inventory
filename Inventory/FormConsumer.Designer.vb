...
Partial Class FormConsumer
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FormConsumer))
        Label1 = New Label()
        ...
        DataGridViewConsumer = New DataGridView()
        No = New DataGridViewTextBoxColumn()
        Id = New DataGridViewTextBoxColumn()
        Nama = New DataGridViewTextBoxColumn()
        PanelRefresh = New Panel()
        CType(DataGridViewConsumer, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Label1
        ' 
        ...
        ' 
        ' DataGridViewConsumer
        ' 
        DataGridViewConsumer.AllowUserToAddRows = False
        DataGridViewConsumer.AllowUserToDeleteRows = False
        DataGridViewConsumer.BackgroundColor = SystemColors.Control
        DataGridViewConsumer.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        DataGridViewConsumer.Columns.AddRange(New DataGridViewColumn() {No, Id, Nama})
        DataGridViewConsumer.Cursor = Cursors.Hand
        ...
        DataGridViewConsumer.DefaultCellStyle = DataGridViewCellStyle1
        DataGridViewConsumer.Dock = DockStyle.Bottom
        DataGridViewConsumer.Location = New Point(10, 189)
        DataGridViewConsumer.Name = "DataGridViewConsumer"
        DataGridViewConsumer.ReadOnly = True
        DataGridViewConsumer.Size = New Size(664, 262)
        DataGridViewConsumer.TabIndex = 18
        ' 
        ' No
        ' 
        No.HeaderText = "No"
        ...
        PanelRefresh.Location = New Point(651, 28)
        ...
        Controls.Add(DataGridViewConsumer)
        ...
        ShowInTaskbar = False
        Text = "Cunsomers"
        CType(DataGridViewConsumer, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub
    ...
    Friend WithEvents DataGridViewConsumer As DataGridView
