...
Namespace Repositories
    Public Class BarangKeluarRepository
        ...
        Public Shared Function GetTotalByMonth() As Integer
            Database.OpenConnection()
            Try
                Dim Command As New MySqlCommand("SELECT COUNT(barang_id) AS jumlah_barang FROM barang_keluar WHERE MONTH(created_at) = MONTH(CURDATE()) AND YEAR(created_at) = YEAR(CURDATE())", Database.Connection)
